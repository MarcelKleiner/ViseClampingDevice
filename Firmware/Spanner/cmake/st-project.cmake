...
# BASED ON C:\Users\marce\Documents\Repos\ViseClampingDevice\Firmware\Spanner
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32L412K8TX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32L412K8TX_FLASH.ld>"
)
