...
Core/Src/Encoder/%.o Core/Src/Encoder/%.su: ../Core/Src/Encoder/%.cpp Core/Src/Encoder/subdir.mk
...
clean-Core-2f-Src-2f-Encoder:
	-$(RM) ./Core/Src/Encoder/Encoder.d ./Core/Src/Encoder/Encoder.o ./Core/Src/Encoder/Encoder.su
