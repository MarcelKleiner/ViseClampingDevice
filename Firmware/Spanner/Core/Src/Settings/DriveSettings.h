...
public:
	...
	void setInPosDiff(uint16_t inPosDiff);

	uint16_t getOpeningDistance() const;
	void setOpeningDistance(uint16_t openingDistance);

	uint16_t getOverCurrentTimeThreshold() const;
	void setOverCurrentTimeThreshold(uint16_t overCurrentTimeThreshold);
	...
	void setTeachSpeed(uint16_t teachSpeed);

	uint16_t getTeachTroque() const;
	void setTeachTroque(uint16_t teachTroque);

	uint16_t getUnderVoltageError() const;
	void setUnderVoltageError(uint16_t underVoltageError);

	uint16_t getUnderVoltageWarning() const;
	void setUnderVoltageWarning(uint16_t underVoltageWarning);
