...
{
    public class WriteTeachSpeed : CommandBase
    {
        private readonly MainViewModel _mainViewModel;

        public WriteTeachSpeed(MainViewModel mainViewModel, ICommunication communication) : base(communication)
        {
        ...
        private async Task ExecuteInternal()
        {
            ...
            Adresses.RegisterAdress.TEACH_SPEED_ADDR, _mainViewModel.TeachSpeed);
