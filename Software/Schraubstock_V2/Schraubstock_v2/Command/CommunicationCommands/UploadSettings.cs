...
{
    public class UploadSettings : CommandBase
    {
        private readonly MainViewModel _mainViewModel;

        public UploadSettings(MainViewModel mainViewModel, ICommunication communication) : base(communication)
        {
        ...
        private async Task ExecuteInternal()
        {
            ...
            Adresses.Commands.UPLOAD_SETTINGS_ADDR, "0");
